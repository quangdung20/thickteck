        ...
        <div className="grid grid-cols-1 gap-y-10 gap-x-6 md:grid-cols-12 xl:gap-x-8">
          <div className="col-span-12 bg-imagee">
            <div className="mb-10 mt-24 lg:mx-64 lg:my-24">
              <h3 className="text-4xl md:text-55xl text-center font-semibold text-white mb-3">BẢN TIN THICKTECH</h3>
              <h3 className="text-base font-normal opacity-75 text-white text-center mb-8">
                Để nhận được thêm thông tin về các khuyến mãi và sản phẩm mới nhất từ chúng tôi!
              </h3>
