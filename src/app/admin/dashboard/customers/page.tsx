...
import { CustomersFilters } from '@/admin-components/customer/customers-filters';
import { CustomersTable } from '@/admin-components/customer/customers-table';
import type { Customer } from '@/admin-components/customer/customers-table';
